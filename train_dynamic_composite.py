...
from srcs.models.dataloader_dynamic import SalObjDataset, Rescale, RandomCropAndDownSample, ToTensor
...
if __name__ == '__main__':
    ...
    val_num = 0
    momentum = 0.9
    steps = [40, 80, 120]   # [10, 20, 30]
    weight_decay = 0.0005
    lr = 0.01
    gamma = 0.1
    bg_num = 300      # the number of background images

    resume = False
    resume_ckpt = './pretrained/modnet_portrait.ckpt'
    pre_train_dir = "./pretrained/modnet_pretrained.ckpt"

    log_save_path = "logs/modnet_dynamic/"
    mode_save_dir = "saved_model/modnet_dynamic/"
    pre_train_dir = "pretrained/modnet_pretrained.ckpt"
    fg_dir = './data/fg/'
    bg_dir = './data/bg/'
    matte_dir = './data/matte/'
    fotor_dir = './data/fotor_fg/'
